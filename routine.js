...
var devent = new Date(2025, 8, 30, 9); //months start from 0
...
var months_n_days = calcDaysAndMonths(devent, dnow)
var months = months_n_days[0];
var days = months_n_days[1];
...
document.getElementById('daysPast').innerText = days;
